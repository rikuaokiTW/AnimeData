    ...
    if (sliderOne && sliderTwo && inputOne && inputTwo && sliderTrack) {
        function getYears() {
            ...
            if (isInput(inputOne)) {
                ...
                yearsList = Array.from({ length: (currentYear + 1) - initialYear }, (value, index) => initialYear + index);
            }
            ;
            return yearsList;
        }
        ...
        function updateSliders() {
            if (isInput(sliderOne) &&
                isInput(sliderTwo) &&
                isInput(inputOne) &&
                isInput(inputTwo)) {
                if (inputOne.value != sliderOne.value ||
...
;
//# sourceMappingURL=rangeSliders.js.map